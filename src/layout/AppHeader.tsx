  ...
  return (
    <header className="sticky top-0 z-40 flex w-full border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
        <div className="flex w-full items-center justify-between gap-2 border-b border-gray-200 px-3 py-3 dark:border-gray-800 sm:gap-4 lg:w-auto lg:justify-start lg:border-b-0 lg:px-0 lg:py-4">
        ...
        <div
          ...
          } w-full items-center justify-between gap-4 px-5 py-4 shadow-theme-md lg:flex lg:flex-1 lg:justify-between lg:px-0 lg:shadow-none`}
        >
          <div className="hidden lg:block" />

          <div className="ml-auto flex items-center gap-2 2xsm:gap-2">
            <ThemeToggleButton />
